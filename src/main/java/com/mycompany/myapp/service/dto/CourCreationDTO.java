...
public class CourCreationDTO {
    ...
    public CourCreationDTO() {
    }

    public CourCreationDTO(CourStatus courStatus, String description, Integer duree,Long id, String titre, String urlVideo) {
